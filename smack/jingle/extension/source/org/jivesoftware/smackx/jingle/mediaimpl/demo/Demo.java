...
import org.jivesoftware.smackx.jingle.mediaimpl.demo.MySASLPlainMechanism;
...
public class Demo extends JFrame {
    ...
    public Demo(String server, String user, String pass) {
        ...
        ConnectionConfiguration configuration = new ConnectionConfiguration("thaiha", 5222);
        xmppConnection = new XMPPConnection(configuration);
        try {
            xmppConnection.connect();
            
            //xmppConnection.login("xmppserver", "thaiha", "Smack", true);
            xmppConnection.login("thaiha", "thaiha", "Smack", true);
        }
